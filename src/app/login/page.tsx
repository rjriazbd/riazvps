      ...
      <div className="relative z-10 w-full max-w-sm">
        <div className="glass rounded-2xl p-10 shadow-2xl">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-sm font-light">Sign in to continue watching</p>
          </div>

          {/* Login Method Toggle */}
          <div className="flex bg-white/5 rounded-md p-1 mb-8">
            <button
              onClick={() => setLoginMethod("email")}
              className={`flex-1 py-2.5 rounded-sm text-sm font-medium transition-all duration-300 tracking-wide ${
                loginMethod === "email"
          ...
          <form className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2.5 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-3.5 h-3.5 bg-white/5 border border-white/20 rounded accent-primary"
                />
                <span className="text-gray-500 text-xs font-light">Remember me</span>
              </label>
              <Link href="#" className="text-gray-400 hover:text-white text-xs transition-colors font-light">
                Forgot password?
              </Link>
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-primary hover:bg-primary-hover text-white py-3.5 rounded-md font-medium transition-all duration-300 text-sm tracking-wide shadow-lg shadow-primary/20 mt-2"
            >
              Sign In
            </button>
          </form>
